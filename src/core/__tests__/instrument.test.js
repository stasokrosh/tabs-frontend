...
it('Instrument produces chord generators', () => {
    ...
    expect(instrument.getChordGenerator()({}).stringNum).toBe(DEFAULT_STRING_COUNTS.GUITAR);
    instrument = Instrument.Create({code : INSTRUMENT_CODES.BASS});
    expect(instrument.getChordGenerator()({}).stringNum).toBe(DEFAULT_STRING_COUNTS.BASS);
